...
import handshakeBackground from "@/assets/handshake-background.jpg";
    ...
    <div className="min-h-screen flex flex-col lg:flex-row">
      ...
      <div className="w-full lg:w-1/2 bg-white flex items-center justify-center p-4 sm:p-8">
        <div className="w-full max-w-sm sm:max-w-md space-y-6 sm:space-y-8">
          ...
          {/* Header */}
          <div className="text-center">
            <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-1 sm:mb-2">Create an account</h1>
            <p className="text-sm sm:text-base text-gray-600">Sign up or Login</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
            ...
            <Button
              ...
              variant="outline"
              className="w-full border-primary text-primary hover:bg-primary hover:text-white py-2 sm:py-3 text-sm font-medium rounded-lg"
            >
              Login
            </Button>
          </form>
