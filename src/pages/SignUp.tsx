      ...
      <div className="w-full lg:w-1/2 bg-white flex items-center justify-center p-8">
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="text-center">
            ...
            <p className="text-gray-600">Sign up or Login</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <Button
              ...
              variant="outline"
              className="w-full border-primary text-primary hover:bg-primary hover:text-white py-3 text-base font-medium rounded-lg"
            >
              Login
            </Button>
          </form>
