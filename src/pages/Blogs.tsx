      ...
      <section className="py-12" style={{ backgroundColor: "#0D6ABC" }}>
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 lg:gap-6">
            ...
            <div className="relative bg-white rounded-tl-[40px] rounded-tr-[40px] rounded-bl-[40px] overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300 h-64 lg:h-80">
              <img
                src={blogHero1}
              ...
              <div className="absolute bottom-4 left-4 right-4 text-white lg:bottom-6 lg:left-6 lg:right-6">
                <h3 className="text-lg lg:text-xl font-bold mb-1 leading-tight lg:mb-2">
                  Common Mistakes in Real Estate Investing
                </h3>
                <p className="text-xs lg:text-sm text-gray-200 mb-2 opacity-90 lg:mb-4">
                  Real estate investing is one of the most popular ways to...
                </p>
                <Button
                  ...
                  onClick={() =>
                    (window.location.href =
                      "/blogs/common-mistakes-real-estate")
                  }
                >
                  Read more
                </Button>
            ...
            <div className="space-y-4 lg:space-y-6">
              {/* Top medium card */}
              <div className="relative bg-white rounded-tl-[40px] rounded-tr-[40px] rounded-bl-[40px] overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300 h-32 lg:h-36">
                <img
                  src={blogHero2}
                ...
                <div className="absolute bottom-3 left-3 right-3 text-white lg:bottom-4 lg:left-4 lg:right-4">
                  <h3 className="text-sm lg:text-base font-bold mb-2 leading-tight lg:mb-3">
                    Emerging Real Estate Markets to Watch
                  </h3>
                  <Button
                    className="bg-white text-black hover:bg-gray-100 rounded-md px-2 py-1 text-xs font-medium lg:px-3 lg:py-1.5 lg:text-sm"
                    onClick={() =>
                      (window.location.href = "/blogs/emerging-markets")
                    }
                  >
                    Read more
                  </Button>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                {[blogCard1, blogCard2, blogCard3].map((card, idx) => (
                  <div
                    key={idx}
                    className="relative bg-white rounded-tl-[40px] rounded-tr-[40px] rounded-bl-[40px] overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300 h-28 sm:h-32"
                  >
                    <img
                      src={card}
                      alt={`What's happening Know more ${idx + 1}`}
                      className="w-full h-full object-cover"
                    />
                    <div className="absolute inset-0 bg-gradient-to-t from-black/70 via-black/20 to-transparent" />
                    <div className="absolute bottom-2 left-2 right-2 text-white">
                      <h4 className="text-xs font-bold mb-1 leading-tight">
                        What's happening Know more
                      </h4>
                      <Button
                        variant="link"
                        className="text-white p-0 h-auto text-xs underline font-medium"
                        onClick={() =>
                          (window.location.href = `/blogs/whats-happening-${
                            idx + 1
                          }`)
                        }
                      >
        ...
        <div className="container mx-auto px-6">
          <div className="space-y-6 lg:space-y-8">
            {blogPosts.map((post) => (
              <div
                key={post.id}
                className="flex flex-col md:flex-row gap-4 lg:gap-6 p-4 lg:p-6 bg-white rounded-tl-[40px] rounded-tr-[40px] rounded-bl-[40px] shadow-sm border border-gray-100 overflow-hidden"
              >
                <div className="md:w-64 flex-shrink-0">
                  <img
                    src={post.image}
                    alt={post.title}
                    className="w-full h-40 md:h-32 object-cover rounded-tl-[40px] rounded-tr-[40px] rounded-bl-[40px]"
                  />
                </div>
                <div className="flex-1">
                  ...
                  <p className="text-sm text-gray-600 mb-3 leading-relaxed lg:mb-4">
                    {post.subtitle}
                  </p>
                  <Button
                    style={{ backgroundColor: "#0D6ABC" }}
                    className="hover:opacity-90 text-sm px-3 py-1.5 h-auto lg:px-4 lg:py-2"
                  >
                    Read more
                  </Button>
                </div>
